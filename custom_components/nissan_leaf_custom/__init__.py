...
DATA_BATTERY_REMAINING = 'battery_remaining_amount'
DATA_BATTERY_CAPACITY = 'battery_capacity'
...
class LeafDataStore:
    ...
    def __init__(self, hass, leaf, car_config):
        ...
        self.data[DATA_BATTERY_REMAINING] = 0
        self.data[DATA_BATTERY_CAPACITY] = 0
    ...
    async def async_refresh_data(self, now):
        ...
        if server_response is not None:
            ...
            if server_response.answer["status"] == HTTP_OK:
                ...
                #Mine
                self.data[DATA_BATTERY_REMAINING] = int(server_response.battery_remaining_amount)
                self.data[DATA_BATTERY_CAPACITY] = int(server_response.battery_capacity)
